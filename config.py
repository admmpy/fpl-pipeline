...
RECOMMENDED_SQUAD_SCHEMA = {
    ...
    "backfill_trusted": "BOOLEAN",
    "backfill_validation_status": "VARCHAR(50)",
    "backfill_validation_details": "VARCHAR(500)",
    "backfill_validation_version": "VARCHAR(50)",
    "backfill_validated_at": "TIMESTAMP_NTZ",
    "backfill_train_max_target_gw": "INTEGER",
    "backfill_inference_max_source_gw": "INTEGER",
    "player_id": "INTEGER",
    "web_name": "VARCHAR(100)",
    "position_id": "INTEGER",
    "team_id": "INTEGER",
